...
We used both Logistic Regression and Random Forest to classify job postings by industry sector (NAICS2) based on experience, salary, employment type, and state. Logistic Regression performed poorly, with an accuracy of 31%, and failed to predict several classes entirely, likely due to its linear nature and the imbalanced class distribution. In contrast, the Random Forest model achieved 53.5% accuracy and showed much stronger balance across categories, particularly for common sectors like 42 (Wholesale Trade), 52 (Finance), and 54 (Professional Services). While neither model is perfect, Random Forest clearly captures more of the underlying complexity in the data, making it more suitable for this type of multi-class classification task.
